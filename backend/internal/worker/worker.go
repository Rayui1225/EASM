...
func (w *Worker) RegisterTasks() error {
	...
	tasks := map[string]interface{}{
		...
		shared.TaskNames.AssetDiscovery:    w.assetDiscoveryTask,
		shared.TaskNames.DNSEnumeration:    w.dnsEnumerationTask,
		shared.TaskNames.PortScan:          w.portScanTask,
		shared.TaskNames.CleanupOldResults: w.cleanupOldResultsTask,
	}
